...
// addIstioNatTableRules updates a transaction to include the nftables rules for the the IstioProxyNat table.
...
// addIstioMangleTableRules updates a transaction to include the nftables rules for the the IstioProxyMangle table.
// It makes sure the table and the necessary chains exist, then adds rules from the rule builder.
...
// addIstioRawTableRules updates a transaction to include the nftables rules for the the IstioProxyRaw table.
// It makes sure the table and the necessary chains exist, then adds rules from the rule builder.
